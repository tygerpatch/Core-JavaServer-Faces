<html>
  ...
  <f:view>
    <head>
      <title><h:outputText value = "#{Ch5EditingsMsgs.windowTitle}" /></title>
    </head>
    <body>
      <h:form>
        <h:dataTable value = "#{Ch5EditingTableData.names}" var = "name">
          <h:column>
            <f:facet name = "header">
              <h:outputText value = "#{Ch5EditingsMsgs.editColumn}" style = "font-weight: bold" />
            </f:facet>
        ...
        <h:column>
          <f:facet name = "header">
            <h:outputText value = "#{Ch5EditingsMsgs.lastnameColumn}" style = "font-weight: bold" />
          </f:facet>
        ...
        <h:column>
          <f:facet name = "header">
            <h:outputText value = "#{Ch5EditingsMsgs.firstnameColumn}" style = "font-weight; bold" />
          </f:facet>
        ...
        <h:commandButton value = "#{Ch5EditingsMsgs.saveChangesButtonText}" />
      </h:form>
    </body>
  </f:view>
</html>
