<html>
   ...
   <f:view>
      <head>
         ...
         <title>
            <h:outputText value="#{Ch5DeleteMsgs.windowTitle}"/>
         </title>
      </head>
      <body>
         <h:form>
            <h:dataTable value="#{Ch5DeleteTableData.names}" var="name" styleClass="names" headerClass="namesHeader" columnClasses="last,first">
            ...
            <h:commandButton value="#{Ch5DeleteMsgs.deleteButtonText}"
               rendered="#{Ch5DeleteTableData.editable}"
               action="#{Ch5DeleteTableData.deleteNames}"
               disabled="#{not Ch5DeleteTableData.anyNamesMarkedForDeletion}"/>
         </h:form>
      </body>
   </f:view>
</html>
