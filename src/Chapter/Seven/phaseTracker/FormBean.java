package Chapter.Seven.phaseTracker;
...
public class FormBean {
  ...
  public void phaseChange(ValueChangeEvent e) {
    ...
    for (int i = 0; i < listeners.length; i++) {
      ...
      if (listener instanceof Chapter.Seven.phaseTracker.PhaseTracker) {
        ((Chapter.Seven.phaseTracker.PhaseTracker) listener).setPhase((String) e.getNewValue());
      }
    }
  }
